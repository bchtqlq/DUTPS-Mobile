      ...
      () => GestureDetector(
        ...
        child: Row(
          ...
          children: [
            ...
            InputOTP(
                status: listNodeOTP[0].status, value: listNodeOTP[0].value),
            InputOTP(
                status: listNodeOTP[1].status, value: listNodeOTP[1].value),
            InputOTP(
                status: listNodeOTP[2].status, value: listNodeOTP[2].value),
            InputOTP(
                status: listNodeOTP[3].status, value: listNodeOTP[3].value),
            InputOTP(
                status: listNodeOTP[4].status, value: listNodeOTP[4].value),
            InputOTP(
                status: listNodeOTP[5].status, value: listNodeOTP[5].value),
          ],
        ),
      ),
    ),
